...
export default {
  ...
  methods: {
    ...
    async submitOrder() {
      ...
      // 其余的6个参数
      let data = {
        consignee: this.userDefault.consignee, //收件人名字
        consigneeTel: this.userDefault.phoneNum, //收件人手机号
        deliveryAddress: this.userDefault.fullAddress, //收件人地址
